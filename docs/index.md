...
!!! info
    ...
    **Source Code Repository:** [https://github.com/ai-rolling-demo/codgentest-may7](https://github.com/ai-rolling-demo/codgentest-may7)

    **GitOps Repository:** [https://github.com/ai-rolling-demo/codgentest-may7-gitops](https://github.com/ai-rolling-demo/codgentest-may7-gitops)

# **Usage**

To access the codegentest application that was deployed using the Software Template, complete the following instructions:
